...
from swizzleapi.views import RecipeView, TagView, CommentView, MixologistView, CategoryView, IngredientView, MeasurementView
...
router.register(r'measurements', MeasurementView, 'measurement')
